...
function Hero({ navigate, videoSrc }) {
  ...
  const stats = [
    ...
    { val: 100, suf: '%', label: <>لوحة تفاعلية<br />كاملة</>, c: C.bronzeL }
  ]
...
function OverviewCards() {
  const cards = [
...

    {
      ...
      accent: C.bronzeL,
      desc: 'فورمولا 1، إكسبو 2030، كأس العالم 2034، ومواسم الرياض وجدة. تحليل تفصيلي لكل فعالية يشمل أعداد المستهدفين المتوقعة وسعة المرافق.'
    },
  ]
