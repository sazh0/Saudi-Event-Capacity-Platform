...
export function Footer({ navigate }) {
  ...
  const CONTACT = {
    ...
    github: "https://github.com/sazh0",
     whatsapp: 'https://wa.me/966556656100',
     website: 'https://saraabdulaziz-portfolio.vercel.app/',
  }
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                ...
                >
                 ...
                 {/* WhatsApp icon */}
<a href={CONTACT.whatsapp} target="_blank" rel="noopener noreferrer" style={iconStyle}
  onMouseEnter={e => { e.currentTarget.style.background = 'rgba(124,58,237,0.18)'; e.currentTarget.style.color = C.bronzeXL }}
  onMouseLeave={e => { e.currentTarget.style.background = 'rgba(124,58,237,0.08)'; e.currentTarget.style.color = C.grayL }}
>
  <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
...
{/* Website icon 
<a href={CONTACT.website} target="_blank" rel="noopener noreferrer" style={iconStyle}
  onMouseEnter={e => { e.currentTarget.style.background = 'rgba(124,58,237,0.18)'; e.currentTarget.style.color = C.bronzeXL }}
  onMouseLeave={e => { e.currentTarget.style.background = 'rgba(124,58,237,0.08)'; e.currentTarget.style.color = C.grayL }}
>
  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
