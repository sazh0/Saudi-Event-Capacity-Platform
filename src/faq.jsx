...
const DEFAULT_FAQ_AR = [
  ...
  {
    f_id: 4,
    f_question: "كيف تساعد أداة السيناريوهات في دعم التخطيط؟",
    f_answer:
      "تتيح أداة السيناريوهات تعديل سعة المرافق أو أعداد المستهدفين المحليين والدوليين، مع تحديث المؤشرات والرسوم البيانية بشكل فوري لتحليل تأثير التغييرات على سعة المرافق والفجوات الاستيعابية.",
  },
  {
    f_id: 5,
